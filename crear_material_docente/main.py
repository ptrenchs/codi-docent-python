...
archivos_ipynb = contenido_directorio.Filtros_carpetas(rutas = archivos_ipynb,carpetas = '.ipynb_checkpoints,2-ejercicio_resuelto,3-enunciados,4-resuelto_Alumnos').eliminar()
